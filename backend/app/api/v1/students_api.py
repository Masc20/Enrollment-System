...
# Schema/s
from app.schemas.student_sch import *

# Service/s
from app.services.student_ser import *
...
async def get_students(db: AsyncSession = Depends(get_db), page: int = 1, limit: int = Query(default=None, le=settings.MAX_PAGE_LIMIT)):
